class AppConstants {
  ...
  static const String ALL_PRODUCT_KM = "$BASE_URL/khuyenmai/themkhuyenmai";
  static const String Login = "$BASE_URL/login";
  static const String User_all = "$BASE_URL/user";
  static const String User_id = "$BASE_URL/user";
  static const String khachhang = "$BASE_URL/khachhang";
  static const String nhanvien = "$BASE_URL/nhanvien";
  ...
  static const String khcohd = "$BASE_URL/khachhanghd";
