...
class chiitiethoadonmy extends StatefulWidget {
  final int maHoaDon;
  final int makh;
 

  const chiitiethoadonmy(
      {required this.maHoaDon, required this.makh, Key? key})
      : super(key: key);

  @override
  _chiitiethoadonmyState createState() => _chiitiethoadonmyState();
}

class _chiitiethoadonmyState extends State<chiitiethoadonmy> {
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.add_location_alt_outlined), // Icon địa chỉ
                SizedBox(width: 10),
                Text(
                  'Địa chỉ nhận hàng',
                  style: TextStyle(
