...
class theodoidonhangcuaban extends StatefulWidget {
  @override
  _theodoidonhangcuabanState createState() => _theodoidonhangcuabanState();
}

class _theodoidonhangcuabanState extends State<theodoidonhangcuaban> {
...
Widget build(BuildContext context) {
  return Scaffold(
    appBar: AppBar(title: Text("Theo dõi đơn hàng của bạn"),
    centerTitle: true,
            ...
            children: [
              ...
              if (isCustomerFound) ...[
                Column(
                  ...
                  children: [
                    Text('Thông tin của bạn :', style: TextStyle(fontSize: 18)),
                    SizedBox(height: 10),
                    TextField(
